...
public enum AuthErrorCode implements BaseErrorCode {
    ...
    OAUTH_REDIRECT_URI_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "AUTH400_2", "허용되지 않은 OAuth redirect URI입니다."),
    ...
    INVALID_OAUTH_STATE(HttpStatus.UNAUTHORIZED, "AUTH401_7", "OAuth state가 유효하지 않습니다."),
    LOGIN_CODE_NOT_FOUND(HttpStatus.UNAUTHORIZED, "AUTH401_8", "Login code를 찾을 수 없습니다."),
    OAUTH_CONFIGURATION_MISSING(HttpStatus.INTERNAL_SERVER_ERROR, "AUTH500_1", "OAuth 설정이 누락되었습니다."),
    LOGIN_CODE_SERIALIZATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "AUTH500_2", "Login code 처리에 실패했습니다.");
