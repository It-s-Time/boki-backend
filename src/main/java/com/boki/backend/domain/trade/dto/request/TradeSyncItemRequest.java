...
@Schema(description = "API 연동 거래 동기화 항목")
public record TradeSyncItemRequest(
        @Schema(description = "룰셋 ID", example = "1")
        Long ruleSetId,

        @Schema(description = "코인 종류", example = "ETH")
        ...
        @Schema(description = "거래 단가", example = "4500000")
        @NotNull(message = "거래 단가는 필수입니다.")
        @Positive(message = "거래 단가는 0보다 커야 합니다.")
        BigDecimal price,

        @Schema(description = "거래 수량", example = "1.5")
        @NotNull(message = "거래 수량은 필수입니다.")
        @Positive(message = "거래 수량은 0보다 커야 합니다.")
        BigDecimal quantity,

        @Schema(description = "거래 일시", example = "2026-05-08T11:00:00")
